...
$res=mysqli_query($link, "select * from questions where category='$_SESSION[quiz_category]' && question_no=$_GET[questionno]");
        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if(strpos($opt1, 'images/') != false) {
                    ?><img src="admin/<?php echo $opt1; ?>" height="30" width="30"> <?php
                } else{
                    echo $opt1;
                }
                ?>
         ...
         <tr>
            ...
            <td style="padding-left: 10px">
                ...
                if(strpos($opt3, 'images/') != false) {
                    ?><img src="admin/<?php echo $opt3; ?>" height="30" width="30"> <?php
                } else{
                    echo $opt3;
                }
                ?>
